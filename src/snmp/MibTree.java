...
public class MibTree {
	...
	private void addSimpleOids() {
		...
		this.simple_oids.add(new Oid("udpNoPorts", ".1.3.6.1.2.1.7.4.0"));
		this.simple_oids.add(new Oid("udpInErrors", ".1.3.6.1.2.1.7.4.0"));
		this.simple_oids.add(new Oid("udpOutDatagrams", ".1.3.6.1.2.1.7.4.0"));
	...
	private void addEditableOids() {
		this.editable_oids.add(new Oid("sysContact", ".1.3.6.1.2.1.1.4.0"));
		this.editable_oids.add(new Oid("sysName", ".1.3.6.1.2.1.1.5.0"));
		this.editable_oids.add(new Oid("sysLocation", ".1.3.6.1.2.1.1.6.0"));
